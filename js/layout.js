...
<div class="official-bar" role="note">
  <div class="official-bar-inner">
    ...
    <span class="official-bar-links">
      ...
      <a href="${corp}" target="_blank" rel="noopener noreferrer"></a>
    </span>
  </div>
</div>`;
  }
...
<div class="mobile-menu" id="mobile-menu" aria-hidden="true">
  ...
  <div class="mobile-menu-panel">
    ...
    <div class="mobile-contact">
      <a href="${C.officialLinkedIn}" target="_blank" rel="noopener noreferrer" class="btn btn-linkedin btn-block btn-lg">${linkedInIcon} LinkedIn</a>
